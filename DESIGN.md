...
- **Sky.** A horizon-to-zenith gradient, a sunrise/sunset band that wraps the horizon and is strongest toward the sun, a haze around the sun, a sun disc and the moon, the star field (Part XVIII), and **clouds** — four octaves of value noise projected onto a plane overhead, drifting with the game clock, lit by the sky and the sun with a brighter rim toward it. Stars and the moon are veiled by cloud.
