...
Three independently toggleable effects (Graphics Settings, saved; all off by default — bloom, 4.10, is the fourth and is on), each built so it costs nothing while off and, while on, scales with screen pixels or with what changed — never with world size:
...
- **Sun and moon.** Direct light by the face's facing (N·L), white-gold high in the sky and orange near the horizon; moonlight is faint and blue and only exists while the moon is up at night.
