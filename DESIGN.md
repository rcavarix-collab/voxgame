...
Three independently toggleable effects (Graphics Settings, saved; all off by default), each built so it costs nothing while off and, while on, scales with screen pixels or with what changed — never with world size:
