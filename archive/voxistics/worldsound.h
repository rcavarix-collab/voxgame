...
void WorldSoundPlace(BlockID id, int x, int y, int z); // a block was placed (Set), at that cell
void WorldSoundBreak(BlockID id, int x, int y, int z); // a block was taken from that cell
