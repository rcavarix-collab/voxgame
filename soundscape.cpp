...
SoundMaterial BlockSoundMaterial(BlockID id) {
    ...
    case BLOCK_LOG_BEAM: case BLOCK_WOOD_BEAM: case BLOCK_WOOD_CORBEL: case BLOCK_WOOD_SHUTTER: case BLOCK_WOOD_AWNING: case BLOCK_WOOD_STRUT:
        return MAT_WOOD;
    case BLOCK_LEAF_PAD: case BLOCK_FERN_COIL: case BLOCK_SPROUT_COIL:
        return MAT_PLANT;
    case BLOCK_MOSS_CANOPY:
        return MAT_WOOD;
    case BLOCK_GLOWCAP:
        return MAT_FLESH;
...
SoundClass BlockSoundClass(BlockID id) {
    ...
    case BLOCK_MOSS_CANOPY: case BLOCK_FERN_COIL: case BLOCK_SPROUT_COIL: case BLOCK_GLOWCAP:
        return SC_NATURAL;
